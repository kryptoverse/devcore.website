...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Integrating advanced artificial intelligence and machine learning models into scalable systems. I specialize in building RAG pipelines, deploying open-source LLMs, and creating intelligent, data-driven applications.',
      items: [
        'LLMs, Hugging Face, PyTorch, TensorFlow',
        'RAG Pipelines & Vector Databases',
        'Computer Vision, Scikit-learn, FastAPI',
      ],
    },
    {
      id: '03',
      ...
      description:
        'Streamlining end-to-end business operations by replacing manual workflows with robust, rule-based and AI-driven automation systems. I build automated data pipelines, scrapers, and intelligent agents.',
      items: [
        'n8n, Playwright, Selenium, Scripting',
        'OpenClaw, Claude Code, AI Agents',
