...
function AppProjects() {
    ...
    const [appProjectsList, setAppProjectsList] = useState<any>(null)
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setAppProjectsList(data?.appProjectsList)
            } catch (error) {
                ...
                <div className='container'>
                    <div className='flex flex-col justify-center items-center gap-10 md:gap-20'>
                        <div className='max-w-2xl text-center'>
                            <h2>
                                <TextGenerateEffect words="Building native and cross-platform" duration={0.5} />
                                <TextGenerateEffect
                                    words="Mobile Apps"
                                    delay={1.2}
                        ...
                        <div className='grid md:grid-cols-2 gap-x-6 gap-y-8 w-full'>
                            {appProjectsList?.map((items: any, index: number) => (
                                <motion.div
                                    key={index}
