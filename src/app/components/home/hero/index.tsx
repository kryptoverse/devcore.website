          ...
          <div ref={ref} className='flex flex-col gap-8'>
            ...
            <div
              ...
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Full-stack AI developer and mobile app engineer. I build
                intelligent web platforms, Android &amp; iOS apps, CRMs and
                automation systems that help startups and brands move faster.
              </p>
            </div>
