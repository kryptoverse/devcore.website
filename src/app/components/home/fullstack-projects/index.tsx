...
function FullStackProjects() {
    ...
    const [fullStackProjectsList, setFullStackProjectsList] = useState<any>(null)
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setFullStackProjectsList(data?.fullStackProjectsList)
            } catch (error) {
                console.error('Error fetching full-stack projects:', error)
            }
        }
        fetchData()
    }, [])
                ...
                <div className='container'>
                    <div className='flex flex-col justify-center items-center gap-10 md:gap-20'>
                        ...
                        <div className='grid md:grid-cols-2 gap-x-6 gap-y-8 w-full'>
                            {fullStackProjectsList?.map((items: any, index: number) => (
                                <motion.div
                                    key={index}
